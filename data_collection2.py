...
Your job is to help debug the model's line of reasoning by evaluating the individual facts that it used. 
For each fact in the answer, provide a probability score from 0 to 100 reflecting how often the statement holds true in the wild.
0.00 is "Impossible"
10.00 is "Unlikely"
25.00 is "Somewhat Unlikely"
75.00 is "Somewhat Likely"
90.00 is "Likely"
100.00 is "Certain"
...
DEBUG 1:
{{"a space heater is a kind of electrical device": 100.00, "an electrical device turns on / off": 81.45}}
...
DEBUG 2:
{{"the spines of a cactus help it survive by keeping predators away": 100.00, "keeping predators away helps a cactus get moisture": 31.10}}
...
if __name__ == "__main__":
    ...
    # print(all_outputs)
    myFile = open(f'{args.out_dir}/{args.dataset}/ai2_chatgpt_anno_2_1.csv', 'w')
